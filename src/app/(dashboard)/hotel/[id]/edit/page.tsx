...
import { HotelRatesView } from "@/components/hotel/hotel-rates-view";
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Update hotel details and manage its rate plans.</p>
      </div>
      <HotelForm
        mode="edit"
        hotelId={hotel.id}
      ...
      <HotelRatesView hotelId={hotel.id} currency={hotel.currency} seasons={hotel.seasons} />
    </div>
  );
}
