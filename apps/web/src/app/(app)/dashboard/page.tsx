  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Overview of your agency&apos;s pipeline and bookings.</p>
      </div>

      <div className="grid grid-cols-4 gap-4">
        <StatCard label="Total clients" value={String(clientCount)} icon={Users} accent="accent" />
        <StatCard label="Active bookings" value={String(activeTripsCount)} icon={Briefcase} accent="secondary" />
        <StatCard
          ...
          accent="success"
        />
        <StatCard label="Upcoming trips" value={String(upcomingTrips.length)} icon={CalendarClock} accent="warning" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <SimpleBarChart data={pipelineData} color="#1677FF" />
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <SimpleBarChart data={tripStatusData} color="#12B8A6" />
          </CardContent>
        </Card>
      </div>
