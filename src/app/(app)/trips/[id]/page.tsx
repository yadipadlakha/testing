      ...
      <div className="flex items-start justify-between">
        <div>
          <p className="text-sm text-slate-500">
            <Link href={`/clients/${trip.client.id}`} className="hover:text-indigo-600">
              {trip.client.name}
            </Link>
          </p>
          ...
          <Card>
            <CardHeader className="flex-row items-start justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-slate-600">{trip.itinerary.summary}</p>
              </div>
            ...
            <CardContent>
              <details className="group">
                <summary className="flex w-fit cursor-pointer items-center gap-1.5 text-sm font-medium text-indigo-600">
